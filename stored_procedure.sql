...
begin
  DECLARE precio_total DECIMAL(10,2);SET precio_total = precio_unitario * cantidad * (1 - descuento);SELECT precio_total AS 'precio_total';END $$
DELIMITER;
...
begin
  DELETE
  FROM   clientes
  WHERE  cliente_id = cliente_id;END $$
DELIMITER ;
